...
export interface Blobs {
     ...
     */
    postBlob(authorization: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.PostBlobResponse>): void;
    postBlob(authorization: string, callback: ServiceCallback<models.PostBlobResponse>): void;
     ...
     * doc in ms-rest index.d.ts for details
     */
    getBlob(blobHandle: string, authorization: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<any>): void;
    getBlob(blobHandle: string, authorization: string, callback: ServiceCallback<any>): void;
}
...
export interface Images {
     ...
     * doc in ms-rest index.d.ts for details
     */
    postImage(imageType: string, authorization: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.PostImageResponse>): void;
    postImage(imageType: string, authorization: string, callback: ServiceCallback<models.PostImageResponse>): void;
     ...
     * doc in ms-rest index.d.ts for details
     */
    getImage(blobHandle: string, options: { appkey? : string, authorization? : string, customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<any>): void;
    getImage(blobHandle: string, callback: ServiceCallback<any>): void;
}
